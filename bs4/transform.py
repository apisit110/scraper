...
def transformMakroPro():
  # ...
  return

def transformWatsons():
  # ...
  return
...
def transformFreshket():
  ...
  # print(df.shape) # return row, column
  # print(df.head(3)) # จะเรียกมาแค่ 3 แถวแรกเท่านั้น
  df.info() # ดูชื่อของคอลัมน์ พร้อมประเภทตัวแปร
